...
class ConfigMenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if selection == "Permissions":
            ...
            from Cogs.Configuration.Components.Welcome import WelcomeEmbed, WelcomeOptions

            embed = await WelcomeEmbed(interaction, Config, embed)
            view = discord.ui.View()
            view.add_item(WelcomeOptions(interaction.user))
